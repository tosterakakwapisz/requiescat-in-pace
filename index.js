  ...
  if (msg.content.startsWith('!a')) {
    try {
      ...
      filteredMembers.forEach(async member => {
        let servClosedMsg = `Przepraszamy, nasz serwer: ${msg.guild.name} zostaje zamknięty, z tego powodu przenosimy się na nowy serwer: https://discord.gg/${process.env.INVITE} \nPrzepraszamy za niedogodnienia i życzymy miłego pobytu na nowym serwerze!`;

        member.send(servClosedMsg).then(msgSent => {
